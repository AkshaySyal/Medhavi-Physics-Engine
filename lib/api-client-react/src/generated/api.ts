 ...
 */
export const getListPhysicsTopicsUrl = () => {
  return `/api/physics/topics`;
};

export const listPhysicsTopics = async (
  options?: RequestInit,
): Promise<PhysicsTopic[]> => {
  return customFetch<PhysicsTopic[]>(getListPhysicsTopicsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getListPhysicsTopicsQueryKey = () => {
  return [`/api/physics/topics`] as const;
};

export const getListPhysicsTopicsQueryOptions = <
  TData = Awaited<ReturnType<typeof listPhysicsTopics>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listPhysicsTopics>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getListPhysicsTopicsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listPhysicsTopics>>
  > = ({ signal }) => listPhysicsTopics({ signal, ...requestOptions });
...
export type ListPhysicsTopicsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listPhysicsTopics>>
>;
export type ListPhysicsTopicsQueryError = ErrorType<unknown>;

/**
 * @summary List available physics topics and example prompts
 */

export function useListPhysicsTopics<
  TData = Awaited<ReturnType<typeof listPhysicsTopics>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getListPhysicsTopicsQueryOptions(options);
 ...
 */
export const getListPhysicsArtifactsUrl = (id: number) => {
  return `/api/physics/conversations/${id}/artifacts`;
};

export const listPhysicsArtifacts = async (
  id: number,
  options?: RequestInit,
): Promise<PhysicsArtifact[]> => {
  return customFetch<PhysicsArtifact[]>(getListPhysicsArtifactsUrl(id), {
    ...options,
    method: "GET",
  });
};

export const getListPhysicsArtifactsQueryKey = (id: number) => {
  return [`/api/physics/conversations/${id}/artifacts`] as const;
};

export const getListPhysicsArtifactsQueryOptions = <
  TData = Awaited<ReturnType<typeof listPhysicsArtifacts>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listPhysicsArtifacts>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListPhysicsArtifactsQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listPhysicsArtifacts>>
  > = ({ signal }) => listPhysicsArtifacts(id, { signal, ...requestOptions });
...
export type ListPhysicsArtifactsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listPhysicsArtifacts>>
>;
export type ListPhysicsArtifactsQueryError = ErrorType<unknown>;

/**
 * @summary List all computation artifacts for a conversation
 */

export function useListPhysicsArtifacts<
  TData = Awaited<ReturnType<typeof listPhysicsArtifacts>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  ...
  const queryOptions = getListPhysicsArtifactsQueryOptions(id, options);
